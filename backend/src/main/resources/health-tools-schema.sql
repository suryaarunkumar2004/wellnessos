-- Health Tools Tables for 70+ Features
...
INSERT INTO health_articles (title, content, category, author, read_time) VALUES
('How to Stay Healthy This Season', 'Tips and tricks for maintaining good health...', 'Wellness', 'Dr. Wellness', 5),
('Understanding Nutrition Labels', 'Learn to read nutrition labels effectively...', 'Nutrition', 'Nutritionist', 8),
('Benefits of Regular Exercise', 'Why exercise is important for your health...', 'Fitness', 'Fitness Expert', 6),
('Managing Stress Effectively', 'Stress management techniques for daily life...', 'Mental Health', 'Psychologist', 7);

-- Insert sample health challenges
INSERT INTO health_challenges (name, description, duration_days, start_date, end_date) VALUES
('10,000 Steps Challenge', 'Walk 10,000 steps every day for a week', 7, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 DAY)),
('Water Challenge', 'Drink 3L of water daily for 5 days', 5, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 DAY)),
('Sleep Challenge', 'Get 7+ hours of quality sleep for 10 days', 10, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 DAY));
...
SELECT 
    ...
    COUNT(DISTINCT me.id) AS meal_entries,
    COUNT(DISTINCT me2.id) AS mood_entries,
...
LEFT JOIN food_entries me ON u.id = me.user_id
LEFT JOIN mood_entries me2 ON u.id = me2.user_id
