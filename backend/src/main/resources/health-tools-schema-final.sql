-- Health Tools Tables for 70+ Features (Final - No Duplicate Indexes)
...
INSERT IGNORE INTO health_articles (title, content, category, author, read_time_minutes) VALUES
...
INSERT IGNORE INTO health_challenges (challenge_name, challenge_description, duration_days, start_date, end_date) VALUES
